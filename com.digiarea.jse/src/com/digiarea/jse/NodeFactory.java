...
class NodeFactory {
     ...
     */
    public static CreationReference CreationReference() {
        return new CreationReference();
    }
     ...
     * @return the creation reference
     */
    public static CreationReference CreationReference(Type type, NodeList<Type> typeArgs, NodeList<AnnotationExpr> annotations, int posBegin, int posEnd) {
        return new CreationReference(type, typeArgs, annotations, posBegin, posEnd);
    }
     ...
     * @return the expression method reference
     */
    public static ExpressionMethodReference ExpressionMethodReference(Expression expression, String methodName, NodeList<Type> typeArgs, NodeList<AnnotationExpr> annotations, int posBegin, int posEnd) {
        return new ExpressionMethodReference(expression, methodName, typeArgs, annotations, posBegin, posEnd);
    }
     ...
     */
    public static SuperMethodReference SuperMethodReference() {
        return new SuperMethodReference();
    }
     ...
     * @return the super method reference
     */
    public static SuperMethodReference SuperMethodReference(NameExpr qualifier, String methodName, NodeList<Type> typeArgs, NodeList<AnnotationExpr> annotations, int posBegin, int posEnd) {
        return new SuperMethodReference(qualifier, methodName, typeArgs, annotations, posBegin, posEnd);
    }
     ...
     */
    public static TypeMethodReference TypeMethodReference() {
     ...
     * @return the type method reference
     */
    public static TypeMethodReference TypeMethodReference(Type type, String methodName, NodeList<Type> typeArgs, NodeList<AnnotationExpr> annotations, int posBegin, int posEnd) {
        return new TypeMethodReference(type, methodName, typeArgs, annotations, posBegin, posEnd);
    }
